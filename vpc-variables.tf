...
variable "vpc_name" {
  type        = string
  default     = ""
  description = "gke-terraform-433423"
}
variable "ip_cidr_range" {
  type        = string
  default     = ""
  description = "range of IP addresses belonging to the subnetwork secondary range"
}
variable "routing_mode" {
  type        = string
  default     = "GLOBAL"
  description = "network routing mode (default 'GLOBAL'). Possible values are: REGIONAL, GLOBAL"
}
